d3.parcoords = function(config) {
    var __ = {
        ...
        width: 600,
        height: 300,
        margin: { top: 30, right: 12, bottom: 12, left: 32 },
        nullValueSeparator: "undefined", // set to "top" or "bottom"
        nullValueSeparatorPadding: { top: 8, right: 12, bottom: 8, left: 32 },
        color: "#069",
    ...
    pc.applyDimensionDefaults = function(dims) {
        ...
        dims.forEach(function(k) {
            ...
            newDims[k].innerTickSize = newDims[k].innerTickSize ? newDims[k].innerTickSize : 3;
    ...
    function dimensionLabels(d) {
        return title ? title[d] : d; // dimension display names
    }
    ...
    pc.createAxes = function() {
        ...
        g.append("svg:g")
            ...
            .attr({
                "text-anchor": "middle",
                "y": 0,
                "transform": "translate(0,-5) rotate(" + 6 + ")",
                "x": 0,
                "class": "label",
                "font-weight": "bold"
            })
